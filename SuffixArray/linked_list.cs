...
namespace System.Collections.Generic
{
    ...
    /// </summary>
    [Serializable]
	internal sealed class linked_list_node< T >
	{
		internal linked_list_node< T > _Next;
		internal T                     _Item;
		...
		public linked_list_node< T > Next
		{
			get { return _Next; }
		}
		...
		[TargetedPatchingOptOut("Performance critical to inline this type of method across NGen image boundaries")]
		public linked_list_node( T value )
		{
			_Item = value;
		}
    ...
    /// </summary>
    [Serializable]
    internal sealed class linked_list< T > : ICollection< T >, IEnumerable< T >, ICollection, IEnumerable
	{
        /// <summary>Enumerates the elements of a <see cref="T:System.Collections.Generic.linked_list`1" />.</summary>
		public struct Enumerator : IEnumerator< T >
		{
			//private linked_list< T >      _List;
			private linked_list_node< T > _Node;
			private T                     _Current;
			...
			internal Enumerator( linked_list< T > list )
			{
				//_List    = list;
				_Node    = list._Head;
				_Current = default(T);
		...
		internal linked_list_node< T > _Head;
		internal int                   _Count;
		...
		public linked_list_node< T > Head
		{
			[TargetedPatchingOptOut("Performance critical to inline this type of method across NGen image boundaries")]
			get { return _Head; }
		}
		...
		{
            var node = new linked_list_node< T >( value );
            if ( _Head == null )
            {
                _Head = node;
            }
		...
		public linked_list_node< T > Find(T value)
		{
			var next = _Head;
            if ( next != null )
            {
		...
		public linked_list< T >.Enumerator GetEnumerator()
		{
		...
		public void Remove( linked_list_node< T > node )
		{
            throw (new NotImplementedException());
		}
